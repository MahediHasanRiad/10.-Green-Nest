...
import { FilterOrderByVendor } from "../Repository/filter-order-by-vendor.repository.js";

export const AllOrderByVendorController = asyncHandler(async (req, res) => {
  /**
  ...
  const filterOrder = await FilterOrderByVendor({
    page,
    limit,
    sortBy,
    sortType,
